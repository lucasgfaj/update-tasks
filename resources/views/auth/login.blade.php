...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <form action="{{ route('login') }}" method="POST" class="bg-white p-6 rounded shadow-md w-full max-w-sm">
        @csrf
        ...
        <p class="text-center text-sm">
            Não tem uma conta?
            <a href="{{ route('register') }}" class="text-blue-500 hover:underline">Registrar-se</a>
        </p>
    </form>
</body>
</html>
